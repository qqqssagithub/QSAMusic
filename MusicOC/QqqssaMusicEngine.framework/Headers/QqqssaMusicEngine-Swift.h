...
SWIFT_CLASS("_TtC17QqqssaMusicEngine17QqqssaMusicPlayer")
@interface QqqssaMusicPlayer : AVQueuePlayer
@property (nonatomic, strong) NSMutableArray * _Nonnull playerItems;
+ (QqqssaMusicPlayer * _Nonnull)sharedInstance;
- (void)deleteAtPlayerIndex:(NSInteger)playerIndex;
- (void)playPlayerItem:(AVPlayerItem * _Nonnull)playerItem;
