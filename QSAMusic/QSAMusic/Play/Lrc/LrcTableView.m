...
+ (instancetype)sharedLrcTableView {
    ...
    dispatch_once(&onceToken, ^{
        ...
        sharedLrcTableView.tableView = [[UITableView alloc] initWithFrame:CGRectMake(8, 12, ScreenWidth - 80 -16, ScreenWidth - 24)];//CGRectMake(8, 8, 240 -16, 320 -16)
        sharedLrcTableView.tableView.backgroundColor = [UIColor clearColor];
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth - 80 -16, (ScreenWidth -24) / 2)];//CGRectMake(0, 0, 240 -16, (320 -16) / 2)
