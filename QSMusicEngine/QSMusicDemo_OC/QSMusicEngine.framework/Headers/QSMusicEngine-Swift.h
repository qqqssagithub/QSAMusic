...
SWIFT_CLASS("_TtC13QSMusicEngine6QSList")
@interface QSList : NSObject

/// 获取最新榜单
///
/// <ul><li>list {</li><li><code>var name : String?
/// 
/// </code></li><li><code>var type : String?
/// 
/// </code></li><li><code>var pic_s210 : String?
/// 
/// </code></li><li><code>var content : [NSDictionary]?
/// 
/// </code></li><li>}</li></ul>
/// \param responseClosure 数据回调闭包, 数据为字典组成的数组, 字典属性包含但不仅限于如下:
+ (void)getList:(void (^ _Nonnull)(NSArray * _Nonnull dataArr))responseClosure;

/// 获取榜单详情
///
/// <ul><li>详情 {</li><li><code>var billboard : NSDictionary?
/// 
/// </code></li><li><code>var song_list : [NSDictionary]?
/// 
/// </code></li><li>}</li></ul>
/// \param responseClosure 数据回调闭包, 数据为字典组成的数组, 字典属性包含但不仅限于如下:
+ (void)requestSingleWithType:(NSString * _Nonnull)type response:(void (^ _Nonnull)(NSDictionary * _Nonnull data))responseClosure;
...
@property (nonatomic, strong) NSMutableArray * _Nonnull currentPlayerItems;
+ (QSMusicPlayer * _Nonnull)sharedInstance;

/// 删除播放列表指定index歌曲
///
/// \param playerIndex 指定index
- (void)playerDeleteAtPlayerIndex:(NSInteger)playerIndex;

/// 播放指定时间
///
/// \param playIndex 指定index
...
/// 播放下一曲
///
/// \param playerItem 指定歌曲
- (void)playerNextIndex;

/// 播放上一曲
///
/// \param playerItem 指定歌曲
- (void)playerPreviousIndex;
...
SWIFT_CLASS("_TtC13QSMusicEngine15QSNewSingleList")
@interface QSNewSingleList : NSObject

/// 获取新碟列表
///
/// <ul><li>list {</li><li><code>var album_id : String?
/// 
/// </code></li><li><code>var author : String?
/// 
/// </code></li><li><code>var title : String?
/// 
/// </code></li><li><code>var pic_small : String?
/// 
/// </code></li><li><code>var pic_big : String?
/// 
/// </code></li><li><code>var pic_radio : String?
/// 
/// </code></li><li>}</li></ul>
/// \param responseClosure 数据回调闭包, 数据为字典组成的数组, 字典属性包含但不仅限于如下:
+ (void)newSingleList:(void (^ _Nonnull)(NSArray * _Nonnull dataArr))responseClosure;

/// 通过albumId获取新碟详情
///
/// <ul><li>songlist {</li><li><code>var lrclink : String?
/// 
/// </code></li><li><code>var song_id : String?
/// 
/// </code></li><li><code>var author : String?
/// 
/// </code></li><li><code>var title : String?
/// 
/// </code></li><li><code>var album_title : String?  //专辑
/// 
/// </code></li><li><code>var pic_big : String?
/// 
/// </code></li><li><code>var versions : String? //""或"伴奏"
/// 
/// </code></li><li>}</li></ul>
/// \param albumId 新碟id
///
/// \param responseClosure 数据回调闭包, 数据为字典组成的数组, 字典属性包含但不仅限于如下:
+ (void)requestSingleWithAlbumId:(NSString * _Nonnull)albumId response:(void (^ _Nonnull)(NSDictionary * _Nonnull data))responseClosure;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13QSMusicEngine18QSSongDetailedList")
@interface QSSongDetailedList : NSObject

/// 获取歌曲id数组详细信息
///
/// \param song _id_list:    歌曲id数组
///
/// \param responseClosure 返回歌曲详情数组和播放资源(AVPlayerItem)数组
- (void)getSongDetailedList:(NSMutableArray * _Nonnull)song_id_list responseClosure:(void (^ _Nonnull)(NSArray * _Nonnull dataArr, NSMutableArray * _Nonnull playerItems))responseClosure;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13QSMusicEngine11QSSongSheet")
@interface QSSongSheet : NSObject

/// 获取推荐歌单
///
/// <ul><li>list {</li><li><code>var title : String?
/// 
/// </code></li><li><code>var pic_300 : String?
/// 
/// </code></li><li><code>var pic_w300 : String?
/// 
/// </code></li><li><code>var songIds : [String]?
/// 
/// </code></li><li><code>var listenum : String?
/// 
/// </code></li><li>}</li></ul>
/// \param responseClosure 数据回调闭包, 数据为字典组成的数组, 字典属性包含但不仅限于如下:
+ (void)getSongSheet:(NSInteger)page responseClosure:(void (^ _Nonnull)(NSArray * _Nonnull dataArr))responseClosure;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
