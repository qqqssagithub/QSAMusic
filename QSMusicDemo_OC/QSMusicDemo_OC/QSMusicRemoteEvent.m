...
- (void)cycleModeWithTitle:(NSString *)title {
    UIView *view;
    if (_style == 0) {
        view = [[UIView alloc] initWithFrame:CGRectMake(QSMUSICSCREEN_WIDTH /2 -70, QSMUSICSCREEN_HEIGHT /2 -150, 140, 44)];
        view.backgroundColor = [UIColor redColor];
    } else {
        view = [[UIView alloc] initWithFrame:CGRectMake(QSMUSICSCREEN_WIDTH /2 -70, QSMUSICSCREEN_HEIGHT -117, 140, 44)];
        view.backgroundColor = [UIColor whiteColor];
    }
    view.layer.cornerRadius = 5;
    view.layer.masksToBounds = YES;
    [QSMusicKeyWindow addSubview:view];
